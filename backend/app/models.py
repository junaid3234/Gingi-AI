...
# Use PostgreSQL-native types when available, fall back to String for SQLite
...
if _is_postgres:
    ...
    # SQLite: store UUIDs as plain strings — uuid.uuid4() returns a UUID object
    # which SQLite can't bind; str() converts it to the 36-char hex form.
    _UUID = String(36)
    _JSONB = JSON
    def _uuid_default():
